...
# Directory Paths
directory_path <- "./data/island_sampling/norm_effect"
maf_output_dir <- file.path(directory_path, "norm_maf_qq_plots")
wo_output_dir <- file.path(directory_path, "norm_wo_qq_plots")
