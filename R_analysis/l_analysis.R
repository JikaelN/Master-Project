...
# Directory Paths
directory_path <- "./data/stepping_sampling/l_effect"
maf_output_dir <- file.path(directory_path, "l_maf_qq_plots")
wo_output_dir <- file.path(directory_path, "l_wo_qq_plots")
...
generate_effect_sizes <- function(n_loci) {
  return(rpareto(n_loci, scale = 0.1, shape = 2))
}
