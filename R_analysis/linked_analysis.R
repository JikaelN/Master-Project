...
# Directory Paths
directory_path <- "./data/stepping_sampling/linked_effect"
maf_output_dir <- file.path(directory_path, "linked_maf_qq_plots")
wo_output_dir <- file.path(directory_path, "linked_wo_qq_plots")
...
generate_effect_sizes <- function(n_loci, allele_frequencies) {
  effect_sizes <- sqrt(allele_frequencies) * rnorm(n_loci)
